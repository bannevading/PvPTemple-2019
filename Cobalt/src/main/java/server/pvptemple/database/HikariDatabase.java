package server.pvptemple.database;
...
public abstract class HikariDatabase {
   ...
   public abstract void init(Connection var1) throws Exception;
   ...
   public boolean cleanup(PreparedStatement preparedStatement, ResultSet resultSet) {
      return this.cleanup((Connection)null, preparedStatement, resultSet);
   }

   public boolean cleanup(PreparedStatement preparedStatement) {
      return this.cleanup((Connection)null, preparedStatement, (ResultSet)null);
   }
