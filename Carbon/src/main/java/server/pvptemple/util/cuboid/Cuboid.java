package server.pvptemple.util.cuboid;
...
public class Cuboid implements Iterable<Block>, Cloneable, ConfigurationSerializable {
   ...
   public Location getCenter() {
      ...
      int y1 = this.y2 + 1;
      int z1 = this.z2 + 1;
      return new Location(this.getWorld(), (double)this.x1 + (double)(x1 - this.x1) / (double)2.0F, (double)this.y1 + (double)(y1 - this.y1) / (double)2.0F, (double)this.z1 + (double)(z1 - this.z1) / (double)2.0F);
   }
